...
function question2 () {
  let reasonablyPriced = []
    ...
    for (let i = 0; i < reasonablyPriced.length; i++) {
...
function question4 (){
  ...
  for (let i = 0; i < itemsMadeOfWood.length; i++) {
...
function question5 () {
  ...
  for (let i = 0; i < EightOrMoreMaterials.length; i++) {
    console.log(EightOrMoreMaterials[i].title + " has " + EightOrMoreMaterials[i].materials.length + " materials:" + "\n")
    for (let m = 0; m < EightOrMoreMaterials[i].materials.length; m++) {
